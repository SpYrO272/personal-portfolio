  ...
  return (
    ...
    variants={fadeIn("up",0.2)}
        ...
        <div>
            ...
            <a className={`text-lg flex gap-2 items-center text-cyan hover:text-orange transition-all duration-500 cursor-pointer sm:justify-self-center ${align=== 'left' ? "md:justify-self-end":"md:justify-self-start"}`}  target="_blank" href={link}>View <BiSolidRightTopArrowCircle /></a>
        </div>
        <div className='max-h-[220px] max-w-[400px] rounded-xl overflow-hidden hover:scale-110 transform transition-all duration-500 relative border border-white'>
            ...
            <img src={image} alt="Proj Image" className='w-full h-full' />
        </div>
    </motion.div>
  )
}
